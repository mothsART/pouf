...
complete -c pouf -n "__fish_use_subcommand" -f -a "internet.color" -d 'give a fake color (hexadécimal, rgb, rgba, hsl and hsla representation)'
...
complete -c pouf -n "__fish_seen_subcommand_from internet.color" -s d -l hexa -d 'give a fake hexadecimal color'
complete -c pouf -n "__fish_seen_subcommand_from internet.color" -s r -l rgb -d 'give a fake rgb color'
complete -c pouf -n "__fish_seen_subcommand_from internet.color" -s a -l rgba -d 'give a fake rgba color'
complete -c pouf -n "__fish_seen_subcommand_from internet.color" -s t -l hsl -d 'give a fake hsl (tsl) color'
complete -c pouf -n "__fish_seen_subcommand_from internet.color" -s l -l hsla -d 'give a fake hsla (tsl) color'
